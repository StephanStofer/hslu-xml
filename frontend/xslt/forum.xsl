...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <xsl:variable name="event"
                  select="document('../../database/events.xml')/events/event[@id=$eventid]"/>
    ...
    <xsl:template match="forum">
        <div class="card mb-4 shadow-sm text-center">
            ...
            <div class="row justify-content-center mt-4">
                <img style=";border: 1px solid #ddd; border-radius: 4px;  max-width: 600px;  height: auto;">
            ...
            <div class="row justify-content-center">
                <div class="card-body shadow p-3 mt-4 mb-5 bg-white rounded" style="max-width:600px;margin:0 auto">
